...
3. **The Controller**:
   * **Movement**: Two Joysticks.
   * **Shooting**: A push button.
   * **Communication**: 2 HC-12 RF transreceiver modules, one communicating with the turret at 433.4MHz and the other with the body at 437.4MHz.
   * **Power Supply**: A 9v battery connected directly to the Arduino.
